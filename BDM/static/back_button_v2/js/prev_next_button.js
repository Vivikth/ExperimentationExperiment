...
function checkSubmit(btn) {
    ...
    if (formValue < 0 || formValue > 30) {
        alert("Your switch-point must be between 0 and 30");
    } else if (formValue < 30 && formValue > 0) {
        if (confirm("Please double-check your switch-point. Remember that your switch-point is a dollar value between 0 and 30. Press OK to proceed.")) {
