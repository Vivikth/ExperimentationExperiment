...
//    return this.yourvalue + ": <b class='mgslider-value'>" + this.f2s(value, false) + "</b>";
    return "<b>" + this.f2s(value, false) + "%" + "</b>";
...
mgslider.prototype.markup = function (position) {
    ...
    return "\
        <table id='" + this.id("wrapper") + "' class='mgslider-wrapper'>\
            <tbody class='mgslider-tbody'>\
                <tr class='mgslider-row'>\
...
mgslider.prototype.printvalue = function (el) {
    if (this.recall && (x = this.previous()) !== undefined) {
        el.innerHTML += this.markup(x);
        this.set(x);
    }
